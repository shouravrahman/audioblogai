    ...
    return (
      <div className="container mx-auto py-12 px-4 max-w-4xl">
        ...
        <div className="prose dark:prose-invert">
          ...
          <p><strong>Device data:</strong> We may also collect data about the device you’re using to access our website. This data may include the device type, operating system, unique device identifiers, device settings, and geo-location data.</p>
          <p><strong>Personal information:</strong> We may ask for personal information, such as your name and email address.</p>
          
          <h2 className="text-2xl font-bold mt-8 mb-4">2. Legal bases for processing</h2>
          <p>We process your personal information lawfully, fairly and in a transparent manner. We collect and process information about you only where we have legal bases for doing so.</p>
          
          <h2 className="text-2xl font-bold mt-8 mb-4">3. Use of information</h2>
          <p>We may use a combination of personally and non-personally identifying information to understand who our visitors are, how they use our services, and how we may improve their experience of our website in future. We do not disclose the specifics of this information publicly, but may share aggregated and anonymised versions of this information, for example, in website and customer usage trend reports.</p>
