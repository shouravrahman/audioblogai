...
export const pricingPlans = [
    ...
    },
    {
        ...
        variantIdMonthly: process.env.NEXT_PUBLIC_LEMONSQUEEZY_PRO_MONTHLY_VARIANT_ID || '',
        variantIdYearly: process.env.NEXT_PUBLIC_LEMONSQUEEZY_PRO_YEARLY_VARIANT_ID || '',
    },
    {
        name: 'Ultra',
        priceMonthly: 30,
        ...
        variantIdMonthly: process.env.NEXT_PUBLIC_LEMONSQUEEZY_ULTRA_MONTHLY_VARIANT_ID || '',
        variantIdYearly: process.env.NEXT_PUBLIC_LEMONSQUEEZY_ULTRA_YEARLY_VARIANT_ID || '',
    }
];
